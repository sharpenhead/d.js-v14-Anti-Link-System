                                ...
                                switch (m.customId) {
                                    case "linktimeout": {
                                        if (!m.member.permissions.has(PermissionFlagsBits.ModerateMembers))
                                            return m.reply({
                                                embeds: [
                                                    new EmbedBuilder()
                                                        .setColor(warningColor)
                                                        .setDescription(`:warning: | ${m.user} is missing the *moderate_members* permission, please try again after you gain this permission.`)
                                                ],
                                                ephemeral: true,
                                            });
                                        ...
                                        const timeoutEmbed = new EmbedBuilder()
                                            .setTitle("Timeout")
                                            .setDescription(
                                                `:warning: | You have received a timeout from \`${msg.guild.name}\` for sending links.`
                                            )
                                            .setTimestamp()
                                            .setColor(warningColor);
